...
void main()  {
  // String filepath = "C:\Users\79991\Downloads\Чертежкафе обмер.dwg";
  // String keyy =
  ...
  // ConverterResult url = await newclient.postJob(filepath, "pdf");
  ...
  //     url.result, "hui", 'pdf', "C:\\Users\\79991\\Downloads\\");
