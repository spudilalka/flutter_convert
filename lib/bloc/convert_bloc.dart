...
Future pickFile(
  ...
  Client newclient = Client(
    ...
    baseUrls: BaseUrls
        .sandbox, //тут я сделал объект класса, но обратиться ниже к нему не могу
  );
  ...
  final ConverterResult formats = await newclient.getSupportedFormats(result
      .files.first.path
      .toString()); // как мне обратиться к newcLient , чтобы не создавать новый класс кажждый раз при вызове ивента????
